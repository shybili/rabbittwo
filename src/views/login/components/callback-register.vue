<template>
  <Form ref="FormCom"  v-slot="{errors}" :validation-schema='mySchema' class="xtx-form">
...
import { userQQPatchCode ,userQQPatchLogin } from '@/api/use'
...
export default {
  ...
  setup (props) {
    ...
    // 完成表单的校验
    const mySchema = {
      account: scheme.accountApi,
      mobile: scheme.mobile ,
      code : scheme.code,
      password:scheme.password,
      rePassword:scheme.rePassword
    }
