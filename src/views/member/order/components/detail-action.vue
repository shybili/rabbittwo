    ...
    <div class="detail-action">
        ...
        <div class="btn">
          ...
          <template v-if="order.orderState === 1">
            ...
            <XtxButton @click="cancelCom(order)" type="gray" size="small">取消订单</XtxButton>
          </template>
          <!-- 待发货 -->
          ...
          <template v-if="order.orderState === 3">
            <XtxButton @click="confirmOrderList(order)" type="primary" size="small">确认收货</XtxButton>
...
import {useDelete ,useConfirm} from '../index.vue'
export default {
  ...
  setup () {
    return {orderStatus ,...useDelete() ,...useConfirm()}
  }
}
</script>
