  ...
  <div class="xtx-pay-checkout-page">
    <div class="container">
      ...
      <div class="wrapper" v-if="orderList">
        ...
        <div class="box-body">
          <!-- 收获地址 -->
          <CheckoutAdress @change="changeAddress" :list="orderList.userAddresses"/>
        </div>
        <!-- 商品信息 -->
        ...
        <div class="box-body">
          <div class="total">
            <dl><dt>商品件数：</dt><dd>{{orderList.summary.goodsCount}}件</dd></dl>
            <dl><dt>商品总价：</dt><dd>¥{{orderList.summary.totalPrice}}</dd></dl>
            <dl><dt>运<i></i>费：</dt><dd>¥{{orderList.summary.postFee}}</dd></dl>
            <dl><dt>应付总额：</dt><dd class="price">¥{{orderList.summary.totalPayPrice}}</dd></dl>
          </div>
        </div>
        <!-- 提交订单 -->
        <div class="submit">
          <XtxButton @click="submitOrderList" type="primary">提交订单</XtxButton>
        </div>
      </div>
    </div>
  </div>
